...
<body>
	...
	<section id="games-box">
		<form action="/store/Storegamelist" id="discountForm" method="post">
			<input type="hidden" id="mainIconParam" name="store-sort">
			<div id="games">
				<div class="main-icon">
					<a href="javascript:goToDiscount()">
						<div>
				...
				<div class="main-icon">
					<a href="javascript:goToRecommend()">
						<div>
	...
	<%-- js --%>
	<script src="/js/mainscreen/mainscreen.js"></script>
